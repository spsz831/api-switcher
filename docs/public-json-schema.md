...
type SchemaCommandOutput = {
  ...
  commandCatalog?: {
    ...
    actions: Array<{
      ...
      consumerProfileIds?: Array<'single-platform-write' | 'readonly-import-batch'>
