...
- [ ] **Step 1: Write failing schema/type expectations for import apply**
...
- [ ] **Step 2: Run schema/type tests to verify they fail**
...
- [ ] **Step 3: Add minimal command/output/error types**
...
- [ ] **Step 2: Run targeted snapshot tests**
...
- [ ] **Step 3: Extend snapshot manifest model minimally**

Add optional provenance field without changing existing rollback decision logic.

- [ ] **Step 4: Re-run targeted snapshot tests**
...
- [ ] **Step 1: Write failing unit tests for source gate**
...
- [ ] **Step 2: Write failing unit tests for local-first gating**
...
- [ ] **Step 3: Write failing unit test for successful user-scope apply path**
...
- [ ] **Step 4: Run import apply unit tests**
...
- [ ] **Step 5: Implement minimal orchestration service**
...
- [ ] **Step 6: Re-run import apply unit tests**
...
- [ ] **Step 1: Write failing CLI integration tests for command shape**
...
- [ ] **Step 2: Write failing CLI integration tests for gate order**
...
- [ ] **Step 1: Write failing renderer tests for success output**
...
- [ ] **Step 2: Write failing renderer tests for failure output**
...
- [ ] **Step 4: Implement renderer support**
...
- [ ] **Step 1: Add failing Gemini-focused integration tests**
...
- [ ] **Step 2: Run Gemini integration tests**
...
- [ ] **Step 3: Fill any orchestration gaps revealed by integration**
...
- [ ] **Step 4: Re-run Gemini integration tests**
...
- [ ] **Step 2: Run public schema tests**
...
- [ ] **Step 4: Re-run public schema tests**
...
- [ ] **Step 4: If anything fails, fix and re-run only the affected slice, then repeat full verification**
