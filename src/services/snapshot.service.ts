...
import type { SnapshotManifest } from '../types/snapshot'
...
export class SnapshotService {
  ...
  async createBeforeApply(adapter: PlatformAdapter, profile: Profile, input: { preview: PreviewResult; validation: ValidationResult }) {
